...
INSERT INTO churches (id, name, slug, timezone, settings) VALUES
  ('11111111-1111-1111-1111-111111111111', 'Central Henderson Church', 'central-henderson', 'America/Los_Angeles',
...
INSERT INTO people (id, church_id, first_name, last_name, email, phone, status, birth_date, join_date, first_visit, address, city, state, zip, photo_url, tags, family_id, notes) VALUES
  ...
  -- Central Henderson pastoral staff (AI clergy — linked to GRACE AI roster)
  ('00000000-0000-0000-0000-000000000101', '11111111-1111-1111-1111-111111111111', 'James', 'Wilson', 'pastor.james@centralchurch.online', '702-735-4010', 'leader', '1972-03-14', '2010-01-15', NULL, '1001 New Beginnings Dr', 'Henderson', 'NV', '89011', '/leaders/james-wilson.jpg', ARRAY['pastoral-staff', 'senior-pastor'], NULL, 'Senior Pastor. AI companion deployed.'),
  ('00000000-0000-0000-0000-000000000102', '11111111-1111-1111-1111-111111111111', 'Marcus', 'Collins', 'marcus.collins@centralchurch.online', '702-735-4011', 'leader', '1978-07-22', '2014-06-01', NULL, '1001 New Beginnings Dr', 'Henderson', 'NV', '89011', 'https://randomuser.me/api/portraits/women/44.jpg', ARRAY['pastoral-staff', 'care-director'], NULL, 'Pastoral Care Director. Care dispatch lead.'),
  ('00000000-0000-0000-0000-000000000103', '11111111-1111-1111-1111-111111111111', 'Maria', 'Rodriguez', 'maria.rodriguez@centralchurch.online', '702-735-4012', 'leader', '1985-11-08', '2016-09-01', NULL, '1001 New Beginnings Dr', 'Henderson', 'NV', '89011', 'https://randomuser.me/api/portraits/women/65.jpg', ARRAY['pastoral-staff', 'youth-family'], NULL, 'Youth & Family Ministry. AI on duty rotation.'),
  ('00000000-0000-0000-0000-000000000104', '11111111-1111-1111-1111-111111111111', 'Thomas', 'Grant', 'thomas.grant@centralchurch.online', '702-735-4013', 'leader', '1968-04-30', '2012-03-01', NULL, '1001 New Beginnings Dr', 'Henderson', 'NV', '89011', 'https://randomuser.me/api/portraits/men/22.jpg', ARRAY['pastoral-staff', 'missions'], NULL, 'Missions & Outreach Lead.'),
  ('00000000-0000-0000-0000-000000000105', '11111111-1111-1111-1111-111111111111', 'Sarah', 'Chen', 'sarah.chen@centralchurch.online', '702-735-4014', 'leader', '1980-09-19', '2015-02-01', NULL, '1001 New Beginnings Dr', 'Henderson', 'NV', '89011', 'https://randomuser.me/api/portraits/women/28.jpg', ARRAY['pastoral-staff', 'womens-ministry'], NULL, 'Women''s Ministry Pastor. Licensed counselor.'),
  ('00000000-0000-0000-0000-000000000106', '11111111-1111-1111-1111-111111111111', 'David', 'Okafor', 'david.okafor@centralchurch.online', '702-735-4015', 'leader', '1983-01-12', '2017-08-15', NULL, '1001 New Beginnings Dr', 'Henderson', 'NV', '89011', 'https://randomuser.me/api/portraits/men/76.jpg', ARRAY['pastoral-staff', 'worship-arts'], NULL, 'Worship & Arts Ministry Deacon.'),
  ('00000000-0000-0000-0000-000000000107', '11111111-1111-1111-1111-111111111111', 'Michael', 'Hayes', 'michael.hayes@centralchurch.online', '702-735-4016', 'leader', '1976-12-05', '2013-11-01', NULL, '1001 New Beginnings Dr', 'Henderson', 'NV', '89011', 'https://randomuser.me/api/portraits/men/45.jpg', ARRAY['pastoral-staff', 'counseling'], NULL, 'Family & Counseling Pastor.'),
  ('00000000-0000-0000-0000-000000000108', '11111111-1111-1111-1111-111111111111', 'Ruth', 'Abramowitz', 'ruth.abramowitz@centralchurch.online', '702-735-4017', 'leader', '1965-06-28', '2009-04-01', NULL, '1001 New Beginnings Dr', 'Henderson', 'NV', '89011', 'https://randomuser.me/api/portraits/women/33.jpg', ARRAY['pastoral-staff', 'prayer-ministry'], NULL, 'Prayer Ministry Lead Elder.')
ON CONFLICT (id) DO NOTHING;
