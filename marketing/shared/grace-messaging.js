...
(function (global) {
  ...
  // a tenant-name comparison silently breaks the moment a third tenant is
  // onboarded, since it would be neither known name).
  const IS_DEMO_TENANT = !!global.GRACE_PORTAL_IS_DEMO;
  ...
  function normalizeLeadersArray(leaders, churchName) {
    ...
    leaders.forEach(function (l) {
      ...
      if (l.name === 'Deacon Robert Hayes' && IS_DEMO_TENANT) {
        ...
        // live tenants use real photos or initials.
