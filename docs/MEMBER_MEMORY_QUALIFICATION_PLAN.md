...
**Status:** qualification gate built; implementation NOT started; policy NOT amended.
**Date:** 2026-09-07
...
- Write **ADR-019** amending ADR-014 (`DECISIONS.md:303`) and ADR-016 (`DECISIONS.md:345`).
