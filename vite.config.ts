        ...
        configureServer(server) {
          server.middlewares.use((_req, res, next) => {
            ...
            res.setHeader(
              'Content-Security-Policy',
              "default-src 'self'; " +
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://challenges.cloudflare.com https://*.clerk.accounts.dev https://*.i.posthog.com https://*.d-id.com; " +
              ...
              "frame-src 'self' https://js.stripe.com https://challenges.cloudflare.com https://*.clerk.accounts.dev https://*.d-id.com; " +
