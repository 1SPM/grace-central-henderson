  ...
  theme: {
    extend: {
      colors: {
        ...
        // #6161FF) live in platform-core's index.css :root; Faithful
        // navy/sky overrides in the admin app's faithful-crm-theme.css.
        // Never fork this palette at build time (see June 2026 Faithful
        // regression).
        // GRACE SaaS brand — the product's own navy. Fixed across ALL
        // tenants (defaults in the admin app's grace-tokens.css); tenant
        // themes must never override --twc-brand-*. Admin chrome uses this;
