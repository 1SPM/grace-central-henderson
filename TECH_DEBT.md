...
- **Lesson:** a large directory move needs its *tooling* config moved with it, and the proof that it was is a green PR — not a green deploy. Promotion-by-hand hid five dead gates for days.
