...
const routes: Record<string, () => Promise<RouteModule>> = {
  ...
  'actions/execute': () => import('./actions/_execute.js'),
  ...
  'community/posts': () => import('./community/_posts.js'),
  'community/reactions': () => import('./community/_reactions.js'),
  ...
  'community/queue': () => import('./community/_queue.js'),
  ...
  'cron/workos-agents': () => import('./cron/_workos-agents.js'),
  ...
  'workos/agent-settings': () => import('./workos/_agent-settings.js'),
