 ...
 * Thumbnails live under apps/admin-web/public/watch/ — a copy of the same
 * art in marketing/assets/watch/ (see watchAssets.ts for why this app owns
 * its own copy rather than depending on marketing/'s deployment).
 */

import type { WatchSermonRow } from './database.types';
import { getTenant } from '@grace/platform-core/tenant';
import { WATCH_LIVE_VIDEO_URL, WATCH_THUMBNAIL_BASE, MEMBER_WATCH_PREVIEW_PATH } from '@grace/platform-core/watchAssets';
