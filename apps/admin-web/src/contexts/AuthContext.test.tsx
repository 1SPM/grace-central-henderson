...
vi.mock('@grace/platform-core/supabase', () => ({
  supabase: {
    from: () => ({
      select: () => ({
        eq: () => ({
...
vi.mock('@grace/platform-core/observability/sentry', () => ({ setSentryUser: vi.fn() }));
vi.mock('@grace/platform-core/observability/posthog', () => ({ identifyUser: vi.fn(), resetUser: vi.fn() }));
