...
// Point at marketing's real deployed domain once it exists; path already
// reflects the tenant-scoped rename.
const DEMO_URL = 'https://grace-crm-two.vercel.app/tenants/faithful/member-portal.html';
