...
import type { CardRecord } from '@grace/platform-core/services/impactCard';
import { cancelCard, freezeCard, issueReplacementCard, unfreezeCard } from '@grace/platform-core/services/impactCard';

vi.mock('@grace/platform-core/services/impactCard', () => ({
