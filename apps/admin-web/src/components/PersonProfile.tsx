              ...
              <div className="flex-1">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  ...
                  {person.tags.includes('portal-demo') && (
                    <a
                      // TODO(Phase 1 M8): marketing/ (previews) has no deployed
                      // domain yet — this same-origin path 404s until it does.
                      href="/tenants/central-henderson/member-portal.html"
                      target="_blank"
