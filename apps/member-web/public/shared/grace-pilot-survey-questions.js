...
window.GRACE_PILOT_SURVEY_TRACKS = {
  "members": [
    {key:"baseline_current_channels",text:"Before the walkthrough, how easy is it to do the task we discussed using Central’s current channels?",type:"likert5",low:"Very difficult",high:"Very easy"},
    {key:"comprehension",text:"After the walkthrough, how clearly do you understand what GRACE is?",type:"likert5",low:"Not clear",high:"Very clear"},
    {key:"usability_navigate",text:"How easy was the GRACE Members experience to navigate?",type:"likert5",low:"Very difficult",high:"Very easy"},
    ...
    {key:"channel_duplication",text:"Compared with the Central tools you already use, would GRACE feel easier, about the same, or like another place to check?",type:"choice",options:["Easier","About the same","Another place to check","Not sure"]},
...
window.GRACE_PILOT_SURVEY_TENANT_TRACKS = {
